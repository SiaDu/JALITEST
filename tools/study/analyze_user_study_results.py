...
----------------------
- Includes U01-U10.
- Excludes U0 and U11 because their questionnaire records are incomplete.
- Excludes U12-U16 because those files are synthetic supervisor-preview records,
...
def main():
    ...
    included_ids = [f"U{i:02d}" for i in range(1, 11)]
    ...
    # Study A participant-level task means
    task_stats = {}
    ...
    # Study B: decode anonymous A/B back to Dialogue-Only (D) and Full-Context (P).
    ...
    summary = {
        ...
        "excluded_incomplete": ["U0", "U11"],
        "excluded_synthetic": ["U12", "U13", "U14", "U15", "U16"],
