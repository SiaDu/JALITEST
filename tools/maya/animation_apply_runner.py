    ...
    for index,event in enumerate(ordered):
        ...
        if mode == "RESET":
            ...
            if target in directions:
                ...
                # Directional GAZE and GLANCE are local eye actions relative
                # to the current persistent gaze. Keep its calibrated
                # eyeStare target and add the offset to CNT_BOTH_EYES.
